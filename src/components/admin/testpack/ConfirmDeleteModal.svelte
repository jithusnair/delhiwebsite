...
<Modal displayModal={display}>
    <div transition:scale|local={{duration: 500}} class="confirm">
        <h2>Confirmation</h2>
        <p>
        Are you sure you want to delete <strong>{testPackTitle}</strong> from
        the database? <br>
        Once deleted, the entire test pack and the tests within cannot be recovered.
