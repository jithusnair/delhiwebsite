...
<Modal displayModal={display}>
    <div transition:scale|local={{duration: 500}} class="confirm">
        <h2>WARNING!!!!</h2>
        <p>
        Are you sure you want to delete <strong>{subjectTitle}</strong> from
        the database? <br>
        Once deleted, every questions belonging to this subject will become
        unrecoverable. PLEASE DELETE CAREFULLY.
