...
<Modal displayModal={display}>
    <div transition:scale|local={{duration: 500}} class="confirm">
        <h2>Confirmation</h2>
        <p>
        Are you sure you want to delete <strong>{examTitle}</strong> from
        the database? <br>
        Once deleted, everything associated with this exam cannot be recovered (Test packs/tests/questions).
